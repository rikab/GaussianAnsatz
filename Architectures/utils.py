...
def build_gIFN_EFN(x_dim, y_dim, Phi_layers, F_layers, acts, pad, opt = None, l2_reg = 0.0, d_l1_reg = 0.0, d_multiplier = 1.0, loadfile = None):
    ...
    model_A = EFN(input_dim=x_dim-1, Phi_sizes=Phi_layers, F_sizes=F_layers, Phi_acts = acts, F_acts = acts, output_act='linear', output_dim= 1,  Phi_l2_regs = l2_reg, F_l2_regs = l2_reg, name_layers = False, ).model
    model_B = EFN(input_dim=x_dim-1, Phi_sizes=Phi_layers, F_sizes=F_layers, Phi_acts = acts, F_acts = acts,  output_act='linear', output_dim= y_dim,  Phi_l2_regs = l2_reg, F_l2_regs = l2_reg, name_layers = False, ).model
    model_D = EFN(input_dim=x_dim-1, Phi_sizes=Phi_layers, F_sizes=F_layers, Phi_acts = acts, F_acts = acts,  output_act='linear', output_dim= y_dim, Phi_l2_regs = l2_reg, F_l2_regs = l2_reg, name_layers = False,).model
    model_C = EFN(input_dim=x_dim-1, Phi_sizes=Phi_layers, F_sizes=F_layers, Phi_acts = acts, F_acts = acts,  output_act='linear', output_dim= y_dim*y_dim, num_global_features = y_dim,  Phi_l2_regs = l2_reg, F_l2_regs = l2_reg, name_layers = False,  ).model
...
def build_gIFN_PFN(x_dim, y_dim, Phi_layers, F_layers, acts, opt = None, l2_reg = 0.0, d_l1_reg = 0.0, d_multiplier = 1.0, loadfile = None):
    ...
    model_A = PFN(input_dim=x_dim, Phi_sizes=Phi_layers, F_sizes=F_layers, Phi_acts = acts, F_acts = acts,  output_act='linear', output_dim= 1,  Phi_l2_regs = l2_reg, F_l2_regs = l2_reg, name_layers = False, ).model
    model_B = PFN(input_dim=x_dim, Phi_sizes=Phi_layers, F_sizes=F_layers, Phi_acts = acts, F_acts = acts,  output_act='linear', output_dim= y_dim,  Phi_l2_regs = l2_reg, F_l2_regs = l2_reg, name_layers = False, ).model
