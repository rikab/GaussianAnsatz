...
x_dim = 3
loadfile = None
savefile = param_dict["dict"] + "EFN.hdf5"
...
for train_count in range(retrain + 1):
    ...
    # Pretain
    if loadfile is None:
        ifn = build_gIFN_EFN(x_dim, y_dim, Phi_sizes, F_sizes, LeakyReLU(), pad, l2_reg = l2_reg, d_l1_reg = d_l1_reg, d_multiplier = d_multiplier)
        print("PRE-TRAINING")
